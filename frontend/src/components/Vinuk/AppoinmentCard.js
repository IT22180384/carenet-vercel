...
const AppoinmetCard = () => {
  ...
  const handleCardClick = () => {
    navigate("/home/appoinmentchart"); // Navigate to the AppoinmentChart route
  };
  ...
  return (
    ...
    >
      <div className="px-6 py-4">
        <div className="font-bold text-xl mb-2">Appoinment Chart</div>
